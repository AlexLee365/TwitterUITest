...
class SampleViewController: TwitterProfileViewController {
    ...
    override func prepareForLayout() {
        // TableViews
        let tweetTableView = UITableView(frame: CGRect.zero, style: .plain)
        self.tweetTableView = tweetTableView

        let photosTableView = UITableView(frame: CGRect.zero, style: .plain)
        self.photosTableView = photosTableView

        let favoritesTableView = UITableView(frame: CGRect.zero, style: .plain)
        self.favoritesTableView = favoritesTableView
